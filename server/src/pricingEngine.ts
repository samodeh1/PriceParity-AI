...
const pppData: Record<string, { multiplier: number; symbol: string; rate: number }> = {
    ...
    "GB": { multiplier: 0.9, symbol: "£", rate: 0.74 },
    "NG": { multiplier: 0.25, symbol: "₦", rate: 1362.27 }, // Current approx rate
    "IN": { multiplier: 0.3, symbol: "₹", rate: 94.96 },
    "BR": { multiplier: 0.45, symbol: "R$", rate: 5.14 }
};
