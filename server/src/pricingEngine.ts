...
interface CountryData {
  ...
  symbol: string;  // Local currency symbol
}

export const pppData: Record<string, CountryData> = {
  // --- TIER: NONE (Full Price - 0% Off) ---
  "US": { tier: "NONE", rate: 1, symbol: "$" },
  "CH": { tier: "NONE", rate: 0.88, symbol: "CHF" },
  "SG": { tier: "NONE", rate: 1.34, symbol: "S$" },
  "LU": { tier: "NONE", rate: 0.92, symbol: "€" },
  "NO": { tier: "NONE", rate: 10.5, symbol: "kr" },
  "IE": { tier: "NONE", rate: 0.92, symbol: "€" },
  "QA": { tier: "NONE", rate: 3.64, symbol: "ر.ق" },
  "IS": { tier: "NONE", rate: 138, symbol: "kr" },
  "DK": { tier: "NONE", rate: 6.85, symbol: "kr" },
  "AU": { tier: "NONE", rate: 1.52, symbol: "A$" },
  "AE": { tier: "NONE", rate: 3.67, symbol: "د.إ" },

  // --- TIER: LOW (20% Off) ---
  "GB": { tier: "LOW", rate: 0.79, symbol: "£" },
  "DE": { tier: "LOW", rate: 0.92, symbol: "€" },
  "FR": { tier: "LOW", rate: 0.92, symbol: "€" },
  "JP": { tier: "LOW", rate: 155, symbol: "¥" },
  "CA": { tier: "LOW", rate: 1.36, symbol: "C$" },
  "KR": { tier: "LOW", rate: 1370, symbol: "₩" },
  "IT": { tier: "LOW", rate: 0.92, symbol: "€" },
  "ES": { tier: "LOW", rate: 0.92, symbol: "€" },
  "NL": { tier: "LOW", rate: 0.92, symbol: "€" },
  "SE": { tier: "LOW", rate: 10.6, symbol: "kr" },

  // --- TIER: MID (50% Off) ---
  "BR": { tier: "MID", rate: 5.15, symbol: "R$" },
  "MX": { tier: "MID", rate: 16.8, symbol: "$" },
  "CN": { tier: "MID", rate: 7.24, symbol: "¥" },
  "IN": { tier: "MID", rate: 83.5, symbol: "₹" },
  "MY": { tier: "MID", rate: 4.73, symbol: "RM" },
  "TH": { tier: "MID", rate: 36.5, symbol: "฿" },
  "PH": { tier: "MID", rate: 57.5, symbol: "₱" },
  "TR": { tier: "MID", rate: 32.2, symbol: "₺" },
  "ID": { tier: "MID", rate: 16000, symbol: "Rp" },

  // --- TIER: HIGH (70% Off) ---
  "NG": { tier: "HIGH", rate: 1339, symbol: "₦" }, 
  "GH": { tier: "HIGH", rate: 14.5, symbol: "GH₵" },
  "KE": { tier: "HIGH", rate: 131, symbol: "KSh" },
  "ZA": { tier: "HIGH", rate: 18.5, symbol: "R" },
  "EG": { tier: "HIGH", rate: 47.5, symbol: "E£" },
  "PK": { tier: "HIGH", rate: 278, symbol: "Rs" },
  "BD": { tier: "HIGH", rate: 117, symbol: "৳" },
  "ZM": { tier: "HIGH", rate: 25.2, symbol: "ZK" }, // Example: Zambia Kwacha
  "TZ": { tier: "HIGH", rate: 2600, symbol: "TSh" },
  "UG": { tier: "HIGH", rate: 3780, symbol: "USh" },

  // Fallback defaults for missing countries
  "DEFAULT": { tier: "MID", rate: 1, symbol: "$" }
};
