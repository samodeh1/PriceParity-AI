[PriceParity AI Dashboard](./public/dashboard.png)
...
MONGO_URI, JWT_SECRET, OPENAI_API_KEY, LEMON_SQUEEZY_API_KEY, LEMON_SQUEEZY_WEBHOOK_SECRET, LEMON_SQUEEZY_STORE_ID, NODE_ENV
Run Dev Mode:
code
Bash
