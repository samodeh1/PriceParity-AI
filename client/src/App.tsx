        ...
        <section className="max-w-6xl mx-auto px-6 pt-10 pb-16 text-center">
          <motion.div initial={{ y: 20, opacity: 0 }} animate={{ y: 0, opacity: 1 }}>
            ...
            <div className="flex flex-row items-center justify-center gap-3 flex-wrap w-full mb-6">
              ...
              <div className="inline-flex items-center justify-center h-10 rounded-full bg-blue-50/60 px-4 text-[10px] font-bold text-blue-600 uppercase tracking-wider leading-none border border-blue-100 gap-1.5">
